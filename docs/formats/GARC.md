...
Status: **public-source reconstruction; retail Pokémon Alpha Sapphire dump not yet available for direct verification**
...
Without a Pokémon Alpha Sapphire source dump, the following remain unverified here:

- exact raw magic bytes in a retail Alpha Sapphire archive
- whether all retail Alpha Sapphire GARCs use identical padding behavior
...
7. When a lawful Pokémon Alpha Sapphire dump becomes available, verify parse → repack behavior and record hashes/revision metadata without committing the ROM itself.
...
- Pokémon Alpha Sapphire path inventory: **blocked pending source dump**
