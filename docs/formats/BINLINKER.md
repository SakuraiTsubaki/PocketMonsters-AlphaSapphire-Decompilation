...
**Public-research baseline; not yet verified against a local Pokémon Alpha Sapphire dump.**
...
Until a real sample is available, the parser must support synthetic test fixtures and must not claim byte-perfect Pokémon Alpha Sapphire compatibility.
