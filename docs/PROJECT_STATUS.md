...
| --- | --- | --- | --- | --- | --- |
| Pokémon Alpha Sapphire retail target | TBD | TBD | TBD | Unverified | Awaiting locally available source for exact identity manifest |
...
- **Alpha Sapphire specific** — observed only in Alpha Sapphire or a specific region/revision/update.
...
1. Generate the first exact Pokémon Alpha Sapphire target identity manifest from a local read-only source.
...
5. Compare verified structures with Omega Ruby before promoting anything to **ORAS common**.
