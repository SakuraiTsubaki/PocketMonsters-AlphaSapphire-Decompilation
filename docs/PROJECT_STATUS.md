...
The comparison origin is the **Japan-market release**, while market/region and in-game language are tracked separately. Alpha Sapphire and Omega Ruby remain distinct targets even where public tools use shared handlers.

## Version inventory

| Target | Region / market | Language | Revision / update | Verification | Notes |
| --- | --- | --- | --- | --- | --- |
| Alpha Sapphire | Japan | selectable; exact set pending registration | Base / 1.0 | Reference only | Official JP site/manual material reviewed; no retail hashes available. |
| Alpha Sapphire | Japan | selectable; exact set pending registration | Ver.1.4 | Reference only | Nintendo Japan currently records 2015-04-23; binary identity not locally verified. |
| Alpha Sapphire | Japan | selectable; exact set pending registration | Ver.1.1–1.3 | Unverified | Non-JP official notices corroborate the update series; Japanese-market notices still need explicit recovery. |
| Alpha Sapphire | Other markets | TBD | Base + applicable updates | Unverified | Region/SKU census pending. |
...
- [ ] Recover and register all Alpha Sapphire update-history sources by market, with JP notices prioritized.
...
1. Finish the Japan-market Alpha Sapphire version/update baseline from official and preserved official sources.
