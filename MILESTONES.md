# Milestones: Pocket Monsters Alpha Sapphire

This roadmap governs research, tooling, analysis, reconstruction, and preservation for `SakuraiTsubaki/PocketMonsters-AlphaSapphire-Decompilation`.
...
| Field | Current value |
| --- | --- |
| Target | Pocket Monsters Alpha Sapphire |
...
Coordinate format findings with Omega Ruby and promote reusable Nintendo 3DS tooling to the common repository.
