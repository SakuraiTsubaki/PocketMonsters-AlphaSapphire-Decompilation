# Target Profile: Pocket Monsters Alpha Sapphire

## Known repository scope

- Repository: `SakuraiTsubaki/PocketMonsters-AlphaSapphire-Decompilation`
- Working target name: Pocket Monsters Alpha Sapphire
